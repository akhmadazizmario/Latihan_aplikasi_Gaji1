            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" style="background-image: url('http://localhost/aplikasi_gaji/assets/img/undraw_profile.svg');width:50px;"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="<?= base_url('login'); ?>" method="post">
                                        ...
                                        <div class="text-center">
                                            <a class="small" href="<?php echo base_url('login/registrasi') ?>">Registrasi!</a>
                                        </div>
                                </div>
                            </div>
                        </div>
